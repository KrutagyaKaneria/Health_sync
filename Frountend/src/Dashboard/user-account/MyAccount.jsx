...
import AmbulanceBooking from '../../components/AmbulanceBooking/AmbulanceBooking.jsx'; 
          ...
          <div className='grid md:grid-cols-3 gap-10'>
            ...
            <div className='md:col-span-2 md:px-[30px]'>
              <div>
                ...
                <button onClick={() => setTab('ambulance')} className={`${tab === 'ambulance' && 'bg-primaryColor text-white font-normal'} p-2 mr-5 px-5 rounded-md text-headingColor font-semibold text-[16px] leading-7 border border-solid border-primaryColor`}>Book Ambulance</button>
              ...
              {tab === 'ambulance' && <AmbulanceBooking />}
