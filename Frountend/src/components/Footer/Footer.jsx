...
const socialLinks = [
  ...
  {
    path: "https://github.com/KrutagyaKaneria",
  ...
  {
    path: "https://www.linkedin.com/in/krutagya-kaneria/",
...
const Footer = () => {
  ...
  return (
    <footer className='pb-16 pt-10 mt-40'>
      <div className="container">
        <div className="flex justify-between flex-col md:flex-row flex-wrap gap-[30px]">
          <div>
            <img src={logo} alt="" />
            <p className='text-[16px] leading-7 font-[400] text-textColor mt-4'>
              Copyright {year} developed by krutagya kaneria all right reserved.
            </p>
