  ...
  return (
    <div className='p-3 lg:p-5'>
      ...
      <div className='mt-2 lg:mt-4 flex items-center justify-between'>
        <span className='bg-[#CCF0F3] text-irisBlueColor py-1 lg:py-2 lg:px-2 text-[12px] leading-4 lg:text-[16px] lg:leading-7 font-semibold rounded'>
            {specialization}</span>
            ...
            <div className='mt-[18px] lg:mt-5 flex item-center justify-center'>
                <div>
